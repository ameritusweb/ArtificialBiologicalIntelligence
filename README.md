...
[Theoretical Foundations](docs/THEORY.md) | [Serialization Thesis](docs/SERIALIZATION_THESIS.md) | [Theories Index](docs/THEORIES.md) | [Structured Open Variables](docs/sov/) | [The Predictable Future](docs/predictable_endpoints.md) | [The Whys](docs/whys.md) | [Constraints](docs/constraints.md)
...
159 formal theoretical claims indexed in `docs/THEORIES.md`:
...
- 102 proposed with falsification criteria — including the three root-level arrivals of the newest arc: T158 (why explanation exists), T159 (where knowing can live), T160 (what the whole apparatus is for)
