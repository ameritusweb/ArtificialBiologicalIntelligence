...
| P108 | The experiment organ: manufacture-loop scheduling (subtraction / isolation / randomization through effectors) earns deconfounded causal structure faster per contact than passive fitting + exploration noise at matched budget | T160 (2026-08-13) | Open — commissioning arc complete (2026-08-14, F49-F59): organ machinery validated end-to-end (nomination, impulse randomization, context-gated subtraction, honest refusal on unrepresentable plants); venue requirement exact per F59 — planted effects must be denominated in body/processing currency (per-step-receptor-visible), not field intensity; successor = body-currency plant or physics-world venue |
...
| P113 | The pressure swap: hazard-graded selection (near-miss mass, calibration error, non-lethal arrivals) grows richer receptor topology than pure survival selection at matched compute — specifically the epistemic/meta calibration families; topology is a fossil record of hazard reduction | T160 x (2026-08-13) | Open |
| P114 | The drift-capacity law: equilibrium settled knowledge is capped by the world's drift-imposed maintenance floor — closed-mass equilibrium scales inversely with dose rate at matched attention | T160 xi (2026-08-13) | Open |
| P115 | R0 as the order parameter of thriving: receipt-computed per-arrival funding (freed rent + opened destinations) separates thriving/surviving/declining venues and predicts compounding | T160 xi (2026-08-13) | Open |
| P116 | Mechanical metamers (T161 Tier 0, in-sim): collapse-response fingerprints separate silhouette-metamer pairs in the physics world; interactive recognition beats silhouette recognition where metamers exist; doubles as P108's body-currency venue | T161 (2026-08-14) | Open — Tier-0 SUPPORTED same day (F62: orientation 0.94 where rotation-invariant statics are anti-perfect at 0.00; class 0.35 vs 0.10 chance; instability 0.00; channel set derived by failure — odd moments carry gravity's verdict). Organism-facing clause open, rides the physics-world venue with P108 |
| P117 | Reality-funded growth: fingerprint-certified objects generate more learnable strain in resident organisms than arbitrary-mutation objects at matched novelty; the world-side receipt buys pedagogical value | T161 (2026-08-14) | Open |
| P118 | The annular law at compose grain: solvent composes arise from intermediate-distance parent pairs; solvency vs parent behavioral distance is inverted-U, not monotone | T162 (2026-08-14) | Open — first bill PARTIAL-by-gate, per-venue decisive (F65): inverted-U in all three LIVE venues (primary absolute: near-parent solvency 0/24), ANTI-U in the spent world — T162 gains its boundary condition (the annulus is a property of live worlds; the inner wall is built from the contradiction budget). Pooled gate was scale-confounded (rank-pooling by rule hereafter) |
| P119 | Annulus-targeted composing: proposing compose pairs from the intermediate band of parent profile-distance raises solvent birth rate and R0 over the standing max-co-fit policy at matched budget | T162 (2026-08-14) | Supported (first bill same day, F66: solvent rate 0.639 vs 0.264 (2.4x), R0 1.54 vs 1.26, paired stream; baseline arm replicates F45/F52; adoption via SCAN_POLICY flag recommended, default flip = user's call) |
| P120 | Theory-driven genesis pays: implication-born (liened) slots fund at >= the rate of matched world-born slots, and the deductive channel raises R0 at matched budget | T163 (2026-08-14) | Open |
| P121 | The retrospective annulus: on the program's own findings ledger, fertile conjunctions cluster at intermediate co-response distance with low provenance overlap | T163 (2026-08-14) | Open |
